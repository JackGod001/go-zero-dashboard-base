...
-- 添加一条user信息 email=test123@163.com password=4c33cff5bb4a673707404508109d0688
insert into `user` (`email`, `password`, `nickname`, `sex`, `avatar`, `info`) values ('test123@163.com', '4c33cff5bb4a673707404508109d0688', 'test123', '0', '', 'test123');
