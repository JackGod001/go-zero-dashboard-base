...
const (
	...
	//应用不存在
	AppNotExistErrorCode = 1500
	//应用未审核通过
	AppNotAuditErrorCode = 1501
	//应用已删除
	AppDeletedErrorCode = 1502
	//应用配置参数缺少
	AppConfigParamsErrorCode = 1503
	//应用配置参数错误请联系客服
	AppConfigErrorCode = 1504
	//应用配置平台收款地址参数错误
	AppConfigPlatformErrorCode = 1505

	//签名错误!
	SignErrorCode         = 1506
	AppNameExistErrorCode = 1507
...
func init() {
	...
	errorMsg[AppNotExistErrorCode] = "应用不存在"
	errorMsg[AppNotAuditErrorCode] = "应用未审核通过"
	errorMsg[AppDeletedErrorCode] = "应用已删除"
	errorMsg[AppConfigParamsErrorCode] = "应用配置参数错误"
	errorMsg[AppConfigErrorCode] = "应用配置参数错误请联系客服"
	errorMsg[AppConfigPlatformErrorCode] = "应用配置平台收款地址参数错误"
	errorMsg[SignErrorCode] = "签名错误"
	errorMsg[AppNameExistErrorCode] = "应用名称已存在"
