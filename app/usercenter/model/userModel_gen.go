...
var (
	...
	cacheGoZeroDashboardBaseUserIdPrefix    = "cache:goZeroDashboardBase:user:id:"
	cacheGoZeroDashboardBaseUserEmailPrefix = "cache:goZeroDashboardBase:user:email:"
)
...
func (m *defaultUserModel) Delete(ctx context.Context, session sqlx.Session, id int64) error {
	...
	goZeroDashboardBaseUserEmailKey := fmt.Sprintf("%s%v", cacheGoZeroDashboardBaseUserEmailPrefix, data.Email)
	goZeroDashboardBaseUserIdKey := fmt.Sprintf("%s%v", cacheGoZeroDashboardBaseUserIdPrefix, id)
	...
	}, goZeroDashboardBaseUserEmailKey, goZeroDashboardBaseUserIdKey)
...
func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	...
	goZeroDashboardBaseUserIdKey := fmt.Sprintf("%s%v", cacheGoZeroDashboardBaseUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, goZeroDashboardBaseUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultUserModel) FindOneByEmail(ctx context.Context, email string) (*User, error) {
	...
	goZeroDashboardBaseUserEmailKey := fmt.Sprintf("%s%v", cacheGoZeroDashboardBaseUserEmailPrefix, email)
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, goZeroDashboardBaseUserEmailKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultUserModel) Insert(ctx context.Context, session sqlx.Session, data *User) (sql.Result, error) {
	...
	goZeroDashboardBaseUserEmailKey := fmt.Sprintf("%s%v", cacheGoZeroDashboardBaseUserEmailPrefix, data.Email)
	goZeroDashboardBaseUserIdKey := fmt.Sprintf("%s%v", cacheGoZeroDashboardBaseUserIdPrefix, data.Id)
	return m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		query := fmt.Sprintf("insert into %s (%s) values (?, ?, ?, ?, ?, ?, ?, ?, ?)", m.table, userRowsExpectAutoSet)
		if session != nil {
			return session.ExecCtx(ctx, query, data.DeleteTime, data.DataStatus, data.Version, data.Email, data.Password, data.Nickname, data.Sex, data.Avatar, data.Info)
		}
		return conn.ExecCtx(ctx, query, data.DeleteTime, data.DataStatus, data.Version, data.Email, data.Password, data.Nickname, data.Sex, data.Avatar, data.Info)
	}, goZeroDashboardBaseUserEmailKey, goZeroDashboardBaseUserIdKey)
...
func (m *defaultUserModel) Update(ctx context.Context, session sqlx.Session, newData *User) (sql.Result, error) {
	...
	return m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		if session != nil {
			return session.ExecCtx(ctx, query, newData.DeleteTime, newData.DataStatus, newData.Version, newData.Email, newData.Password, newData.Nickname, newData.Sex, newData.Avatar, newData.Info, newData.Id)
		}
		return conn.ExecCtx(ctx, query, newData.DeleteTime, newData.DataStatus, newData.Version, newData.Email, newData.Password, newData.Nickname, newData.Sex, newData.Avatar, newData.Info, newData.Id)
	}, goZeroDashboardBaseUserEmailKey, goZeroDashboardBaseUserIdKey)
...
func (m *defaultUserModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheGoZeroDashboardBaseUserIdPrefix, primary)
}
